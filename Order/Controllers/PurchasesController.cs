...
namespace Order.Controllers
{
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PurchaseId,PurchaseAmount,ClientId")] Purchase purchase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PurchaseId,PurchaseAmount,ClientId")] Purchase purchase)
        {
